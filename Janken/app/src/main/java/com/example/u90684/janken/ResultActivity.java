package com.example.v033ff.janken;
...
import com.example.u90684.janken.R;
...
public class ResultActivity extends AppCompatActivity {
    ...
    private void saveData(int myHand, int comHand, int gameResult) {
        ...
        int gameCount = pref.getInt("GAMA_COUNT", 0);
        int winningStreakCount = pref.getInt("LAST_COM_HAND",0);
        int lastComHand = pref.getInt("GAME_RESULT",-1);
